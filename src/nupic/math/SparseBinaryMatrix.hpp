...
public:
  ...
  inline void fromCSR(std::istream &inStream) {
    ...
    if (tag == getVersion()) {
      ...
      std::cout << "Unknown format for sparse binary matrix: " << tag
                << std::endl;
      exit(-1);
    }
  }
  ...
  inline void toCSR(std::ostream &outStream) const {
    { // Pre-conditions
      NTA_CHECK(outStream.good()) << "SparseBinaryMatrix::toCSR: Bad stream";
    } // End pre-conditions

    outStream << getVersion() << " " << nRows() << " " << nCols() << " ";
  ...
  */
    ...
    { // Pre-conditions
      ...
      */
      ...
      NTA_ASSERT((size_type)(end - begin) <= nrows * ncols)
          << "SparseBinaryMatrix::fromSparseVector: "
          << "Invalid number of non-zero indices: " << (size_type)(end - begin)
  ...
  inline void rowFromDense(size_type row, InputIterator begin,
    ...
    { // Pre-conditions
      ...
      NTA_ASSERT((size_type)(end - begin) == nCols())
          << "SparseBinaryMatrix::rowFromDense: "
          << "Invalid vector size " << (size_type)(end - begin) << " vs. "
          << nCols();
    } // End pre-conditions
    ...
    { // Pre-conditions
      ...
      */
      ...
      NTA_ASSERT(nrows * ncols <= (size_type)(end - begin))
          ...
          << " and: " << ncols
          << " when storage has size: " << (size_type)(end - begin);
    } // End pre-conditions
